...
export function MobileNavLinks({
  ...
  return (
    <ul
      id="mobile-nav"
      className={`border-main text-p hover:text-main backdrop-blur-md absolute left-0 top-0 z-[50] flex h-screen flex-col items-center justify-center space-y-9 border-r bg-[#0f0f0f5f] px-24 text-[15px] font-medium drop-shadow-2xl transition-transform duration-200 md:hidden 
