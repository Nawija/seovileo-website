        ...
        >
          {NAV_LINKS.map((link) => (
            <li key={link.label}>
              <Link
                href={link.href}
                className={`rounded-xl px-4 py-2 text-base font-semibold transition-colors duration-300 hover:text-white lg:text-sm lg:font-medium ${
