...
export default function GridSection() {
  return (
    <div className="mx-auto flex max-w-screen-2xl bg-black flex-col items-center justify-center space-y-10 px-3 py-10 text-start md:flex-row md:space-y-0 md:py-20">
      <div className="w-full max-w-screen-sm space-y-5 px-4 md:w-3/4">
        ...
        <p>
          ...
          at explicabo similique doloribus ullam esse aliquam ducimus itaque
          facilis porro molestiae nobis pariatur, repellendus vero, minima
          velit! Qui, ratione?
        </p>
