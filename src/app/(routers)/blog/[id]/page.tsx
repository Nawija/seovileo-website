...
export default async function Pages({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="mx-auto flex h-full w-full flex-grow flex-col items-center justify-start py-10 text-start ">
      ...
      <Image
        ...
        height={600}
        width={600}
        className="mb-10 w-full px-12 max-h-96 object-cover"
      />
      <article
