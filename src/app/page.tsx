...
export default function Home() {
  return (
    <div className="anim-opacity relative mx-auto max-w-[2000px] ">
      <section className="flex items-center justify-center flex-col relative md:flex-row mt-10">
      ...
      <section className="mx-auto my-24 flex flex-col items-center justify-center space-x-4 md:flex-row lg:ml-24">
        <div className="mb-8 text-center font-semibold lg:ml-80 lg:text-start">
          <small className="text-white bg-orange-700 px-2 py-1 font-light">Zobacz</small>
          <p className="text-xl lg:text-2xl text-main mt-1">Najnowsze realizacje</p>
        </div>
